...
dotnet ef migrations add InitialFootball --context FootballContext --project .\SCC.FantasyFootball.DataAccess\SCC.FantasyFootball.DataAccess.csproj --startup-project .\SCC.FantasyFootball\SCC.FantasyFootball.csproj --output-dir .\Football 
dotnet ef migrations add InitialIdentity --context IdentityContext --project .\SCC.FantasyFootball.DataAccess\SCC.FantasyFootball.DataAccess.csproj --startup-project .\SCC.FantasyFootball\SCC.FantasyFootball.csproj --output-dir .\Identity 
...
dotnet ef dbContext scaffold --database "Host=localhost;Database=postgresNew;Username=postgres;Password=Snowboard1" --provider Npgsql.EntityFrameworkCore.PostgreSQL --context FootballContext --project .\SCC.FantasyFootball.DataAccess\SCC.FantasyFootball.DataAccess.csproj --startup-project .\SCC.FantasyFootball\SCC.FantasyFootball.csproj --output-dir .\ -t teams -t players -t games -t stats --force
...
dotnet ef database update --context IdentityContext --project .\SCC.FantasyFootball.DataAccess\SCC.FantasyFootball.DataAccess.csproj --startup-project .\SCC.FantasyFootball\SCC.FantasyFootball.csproj 
